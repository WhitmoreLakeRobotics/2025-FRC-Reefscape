 ...
 *
 */
public class CmdCoralReset extends Command {
    ...
    private ElevatorAndArm.ElevAndArmPos targPos = ElevAndArmPos.PICKUP;
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=VARIABLE_DECLARATIONS

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    
    public CmdCoralReset() {
    ...
    public void execute() {
        ...
        //if(m_elevator.getTargetPos() == ElevAndArmPos.PICKUP && m_elevator.isCoralAtTarget(ElevAndArmPos.PICKUP)){
