...
public class AutoParallelCmd extends Command{
    ...
    public AutoParallelCmd(Supplier<Optional<Pose2d>> poseSupplier,  IntSupplier idSupplier, boolean left, DriveTrain swerve){
    ...
    public AutoParallelCmd( boolean bleft, DriveTrain swerve){
        left = bleft;
        this.swerve = swerve;
    }
