...
public class AutoLookCmd extends Command{
    ...
    public AutoLookCmd(Supplier<Optional<Pose2d>> poseSupplier,  IntSupplier idSupplier, boolean left, DriveTrain swerve){
    ...
    public AutoLookCmd( boolean bleft, DriveTrain swerve){
        left = bleft;
        this.swerve = swerve;
    }
