...
public class RobotContainer {
  ...
  private RobotContainer() {
    ...
    SmartDashboard.putData("Arm Pos Start", new ArmGoToLevel(ElevAndArmPos.START));
    SmartDashboard.putData("Arm Pos Saftey", new ArmGoToLevel(ElevAndArmPos.SAFETYPOS));
    SmartDashboard.putData("Arm Pos lvl1", new ArmGoToLevel(ElevAndArmPos.LEVEL1));
    SmartDashboard.putData("Arm Pos lvl2", new ArmGoToLevel(ElevAndArmPos.LEVEL2));
    SmartDashboard.putData("Arm Pos lvl3", new ArmGoToLevel(ElevAndArmPos.LEVEL3)); 
    SmartDashboard.putData("Arm Pos lvl4", new ArmGoToLevel(ElevAndArmPos.LEVEL4)); 
