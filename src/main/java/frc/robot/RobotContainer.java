...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    Trigger DDown_Drive = new Trigger(drive_Controller.povDown());
        
    Trigger DLeft_Drive = new Trigger(drive_Controller.povLeft());
        
    Trigger DUp_Drive = new Trigger(drive_Controller.povLeft());
                
    Trigger DRight_Drive = new Trigger(drive_Controller.povLeft());
                ...
                Trigger Y_Drive = new Trigger(drive_Controller.y());
  ...
  //  Trigger test = new Trigger(Articulator.povDown(null));
    ...
    Trigger DRight_Artic = new Trigger(Articulator.povRight());
                ...
                Trigger Back_Artic = new Trigger(Articulator.back());
                Trigger Start_Artic = new Trigger(Articulator.start());

                Trigger LBumper_Artic = new Trigger(Articulator.leftBumper());
                Trigger Ltrigger_Artic = new Trigger(Articulator.leftTrigger(0.8));

                Trigger RBumper_Artic = new Trigger(Articulator.rightBumper());
                Trigger Rtrigger_Artic = new Trigger(Articulator.rightTrigger(0.8));

                Trigger LJC_Artic = new Trigger(Articulator.leftStick());
