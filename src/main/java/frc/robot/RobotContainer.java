...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    // Trigger Start_Artic = new Trigger(Articulator.start()); // USE FOR
    // ARTICULATION COAST.
  ...
  public void updateSmartDashboard() {
    // SmartDashboard.putString("Vision Pos",
    // m_driveTrain.vision.getEstimatedGlobalPose(Cameras.RIGHT_CAM).toString());
    ...
    // m_Wipers.leftMotor.getEncoder().getPosition());
