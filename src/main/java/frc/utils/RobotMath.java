...
public class RobotMath {
    ...
    public static double calcKP(double throttle, double minThrottle) {
        ...
        // double full360turndist = Constants.robotPysicalProperties.robotTrackWidth *
        // Math.PI;
        // double full360throttle = full360turndist /
        // Constants.robotPysicalProperties.theoreticalMaxSpeedInches;
    ...
    public static double goToPosStag(double currentPos, double targetPos, double tol, double power, double stagStart,
            double stagPower) {
    ...
    public static double goToPosStagHold(double currentPos, double targetPos, double tol, double power,
            double stagStart, double stagPower, double holdPow, double holdPos) {
